...
public enum ResultCode {
    ...
    ORDER_HAS_ACTIVE_PAYMENT(3010, "订单存在进行中的支付，无法取消"),
    ORDER_AMOUNT_ERROR(3011,"订单金额为空"),
    ...
    THIRD_PARTY_TIMEOUT(6017, "第三方支付接口超时"),
    PAYMENT_SERIALIZE_FAIL(6018, "支付第三方接口请求消息体序列化失败"),
    PAYMENT_DESERIALIZE_FAIL(6019, "支付第三方接口请求消息体反序列化失败"),
    ORDER_STATUS_NOT_PAYABLE(6020, "订单状态异常，无法支付"),
    PAYMENT_RESPONSE_EMPTY(6021, "第三方接口返回结果为空"),
    PAYMENT_RESPONSE_ERROR(6022, "第三方接口返回结果错误"),
    PAYMENT_REFUND_NOT_FOUND(6016, "退款记录不存在");
